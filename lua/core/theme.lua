-- Theme switcher — adapted from Salar's config
-- Default: koda (Salar's exact default theme)
-- :Theme [name]  — pick or set; :ThemeNext / :ThemePrev — cycle
-- Persisted to ~/.local/state/nvim/theme.txt
local M = {}
...
local function apply(name, opts)
  ...
  -- Run koda variant setup before loading the colorscheme (no-op for non-koda)
  koda.setup(name)
